    ...
    <div className="h-full flex flex-col">
      <div className="flex justify-between items-center mb-4">
        <Button
          ...
          className="bg-[#14A090] text-white hover:bg-[#14A090]/90 h-[40px] rounded-[10px] px-[20px] py-[10px]"
        >
        ...
        <Button
          ...
          variant="outline"
          className="text-[#7A9992] dark:text-[#CCCCCC] border-[#7A9992] dark:border-[#CCCCCC] h-[40px] rounded-[10px] px-[20px] py-[10px]"
