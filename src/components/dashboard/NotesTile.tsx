...
export const NotesTile = ({ project }: NotesTileProps) => {
  ...
  return (
    // Ändern Sie h-full zu einer festen Höhe oder viewport-relativen Höhe
    <div className="h-[600px] max-w-[851px] p-6 rounded-[20px] overflow-hidden bg-background border-[0.5px] border-[#CCCCCC] dark:border-[#5E6664] shadow-[5px_20px_20px_rgba(0,0,0,0.1)] dark:shadow-[5px_20px_20px_rgba(255,255,255,0.05)] flex flex-col">
